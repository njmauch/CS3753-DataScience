...
After that is installed, in your command prompt change the directory the nja859_hw1.ipynb file is located

Once there run the command.

jupyter notebook nja859_hwk1.ipynb

This will open the ipynb in your browser. On the browser tab you will see the tab "Kernal", select that then click on "Restart & Run All"
